...
import { Dimmer, Loader, Grid, Card, Image, Button, Popup } from 'semantic-ui-react';
...
const Post = () => {
    ...
    const { id, username, createdAt, body, likes, likesCount, comments, commentsCount } = data.getPost;
                        ...
                        <div >
...

                            {
                                user && user.username===username && (
                                    <Delete postId={id} callback={()=>navigate('/')} style={{marginLeft:'auto'}}/>
                                )
                            }
                        </div>
                     </Card.Content>
